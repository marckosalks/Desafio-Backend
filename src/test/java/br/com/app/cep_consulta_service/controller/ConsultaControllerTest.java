package br.com.app.cep_consulta_service.controller;

import br.com.app.cep_consulta_service.dto.AgenciaResponse;
import br.com.app.cep_consulta_service.dto.ConsultaResponse;
import br.com.app.cep_consulta_service.dto.ViaCepResponse;
import br.com.app.cep_consulta_service.exception.CepNotFoundException;
import br.com.app.cep_consulta_service.service.CepService;
import br.com.app.cep_consulta_service.config.SecurityConfig;
...
class ConsultaControllerTest {
    ...
    void deveRetornar200AoConsultarCepValido() throws Exception {
        ...
        AgenciaResponse agenciaResponse = AgenciaResponse.builder().nome("Agência").build();
        ...
        mockMvc.perform(get("/v1/consulta/05857480")
                ...
                .andExpect(jsonPath("$.agencia.nome").value("Agência"));
    }
